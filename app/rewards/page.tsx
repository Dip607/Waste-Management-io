...
export default function RewardsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col justify-between h-full border-l-4  border-r-4 border-blue-500 mb-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border-t-4  border-b-4 border-green-500">
              ...
              transactions.map(transaction => (
                <div key={transaction.id} className="flex items-center justify-between p-4 border-b border-gray-200 last:border-b-0">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800 border-l-4  " >{transaction.description}</p>
        ...
        <div>
          ...
          <div className="space-y-4">
            {rewards.length > 0 ? (
              rewards.map(reward => (
                <div key={reward.id} className="bg-white p-4 rounded-xl shadow-md border-l-4 border-r-4 border-red-400">
