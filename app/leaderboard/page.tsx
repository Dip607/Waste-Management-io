...
export default function LeaderboardPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-r from-slate-500 to-slate-300 rounded-2x1 border-4 br-3">
      <div className="max-w-3xl mx-auto">
      <h1 className="text-3xl font-semibold mb-6 text-gray-800 pt-10 pl-64">Leaderboard </h1>
        ...
        {loading ? (
          ...
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden shadow-2xl border-l-4  border-r-4 border-blue-500">
