//This is a Collect page of EcoSort Project
...
export default function CollectPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      {loading ? (
        <div className="flex justify-center items-center h-64 border-l-3  border-r-3 border-t-3 border-b-3 border-blue-500">
        ...
        <>
          <div className="space-y-4">
            {paginatedTasks.map(task => (
              <div key={task.id} className="bg-white p-4 rounded-lg shadow-sm border border-l-4   border-r-4 border-blue-500">
